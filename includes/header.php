    ...
    <div class="top-header" style="background-color: white;">
        ...
        <?php
            if(isset($_SESSION['admin'])){
                echo '<li><a  href="dashboard.php" data-hover="Dashboard">Dashboard</a></li>';
                ...
                if (isset($_SESSION['name']) && isset($_SESSION['email'])) {
                    ...
                    if (basename($_SERVER['REQUEST_URI'], '?' . $_SERVER['QUERY_STRING']) == "Registration.php")
                        echo '<li><h1><a  href="registration.php" data-hover="Registration">Registation</a></h1></li>';
                    else
...
<!--<div class="full">
    <div class="col-md-3 top-nav register" style="background-color: white">
        <div class="logo">
            <style>
                .btn-social {
                    width: 100px;
